...
public class MGUsingSeleniumDragAndDrop 
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			Interaction i1=finger.createPointerMove(Duration.ofMillis(0),PointerInput.Origin.viewport(),drag.x,drag.y);
			draganddrop.addAction(i1);
			Interaction i2=finger.createPointerDown(PointerInput.MouseButton.LEFT.asArg());
			draganddrop.addAction(i2);
			Interaction i3=finger.createPointerMove(Duration.ofMillis(5000),PointerInput.Origin.viewport(),drop.x,drop.y);
