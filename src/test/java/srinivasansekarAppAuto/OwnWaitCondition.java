...
public class OwnWaitCondition
{
	public static void main(String[] args) throws Exception
	{
		//own ExpectedCondition 
		//Start appium sever
		...
		try
		{
			...
			wait.until(elementFoundAndClicked(By.xpath("//*[@text='LOG IN']")));
		}
		catch(Exception ex)
		{
	...
	public static ExpectedCondition<Boolean> elementFoundAndfilled(By locator, String x) 
    {
