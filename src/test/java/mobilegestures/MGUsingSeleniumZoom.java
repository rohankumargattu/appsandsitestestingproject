...
public class MGUsingSeleniumZoom 
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			s2.addAction(i4);
			Interaction i5=finger1.createPointerMove(Duration.ofMillis(2000),PointerInput.Origin.viewport(),source.x,(int) (source.y*0.2));
			s1.addAction(i5);
			Interaction i6=finger2.createPointerMove(Duration.ofMillis(2000),PointerInput.Origin.viewport(),source.x,(int) (source.y*0.8));
			s2.addAction(i6);
			...
			Interaction i3=finger1.createPointerDown(PointerInput.MouseButton.LEFT.asArg());
			s1.addAction(i3);
			Interaction i5=finger1.createPointerMove(Duration.ofMillis(1000),PointerInput.Origin.viewport(),source.x,(int) (source.y*0.2));
			s1.addAction(i5);
			Interaction i7=finger1.createPointerUp(PointerInput.MouseButton.LEFT.asArg());
			s1.addAction(i7);
			...
			Interaction i4=finger2.createPointerDown(PointerInput.MouseButton.LEFT.asArg());
			s2.addAction(i4);
			Interaction i6=finger2.createPointerMove(Duration.ofMillis(1000),PointerInput.Origin.viewport(),source.x,(int) (source.y*0.8));
			s2.addAction(i6);
			Interaction i8=finger2.createPointerUp(PointerInput.MouseButton.LEFT.asArg());
			s2.addAction(i8);
