...
public class MGUsingAppiumDragAndDropWithWaitAction 
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			ta.press(ElementOption.element(ele1)).waitAction(wo).moveTo(ElementOption.element(ele2)).release().perform();
			//ta.press(ElementOption.point(dragx,dragy)).waitAction(wo).moveTo(ElementOption.point(dropx,dropy)).release().perform();
			//Validations
			try
			{
